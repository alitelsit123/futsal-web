 <?php
 $SQL =mysqli_query($conn, "SELECT * FROM tboking WHERE usernameboking='$_SESSION[username]'");
 ...
 echo"
  ...
  <tbody>
    ...
    <tr>
      <td width='30%'><h4><strong>TELAGA FUTSAL </strong></h4></td>
	...
	$rincian=mysqli_query($conn, "SELECT * FROM trincian_boking WHERE kdBoking='$_data[kdBoking]'");
