...
if(isset($_SESSION['username']) AND isset($_SESSION['password'])){
	...
	$Query=mysqli_query($conn, "SELECT gambarLapangan FROM tlapangan WHERE kdLapangan ='$_GET[id]'");
	$remove= mysqli_fetch_array($Query);
	
	if($remove['gambarLapangan'] !=""){
		mysqli_query($conn, "DELETE FROM tlapangan WHERE kdLapangan=$_GET[id]")or die (mysqli_error());
