        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="row-fluid">
              ...
              <div class="span6">
                <table class="table table-bordered table-invoice">
                  <tbody>
                    ...
                    <tr>
                    <?php
					$query=mysqli_query($conn, "SELECT MAX (noOrder) As nomorOrder FROM tboking");
              ...
              <div class="modal-header">
                ...
                <h3>DAFTAR JADWAL LAPANGAN TELAGA FUTSAL </h3>
              </div>
          ...
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
               <?php
			   $SQL=mysqli_query($conn, "SELECT * FROM tjadwal,tlapangan,tjam WHERE 
			   ...
			   $no=1;
			   while($_data=mysqli_fetch_array($conn, $SQL)){
              ...
              <div class="span12">
                <table class="table table-bordered table-invoice-full">
                 ...
                 <th>Aksi</th>
                  ...
                  <tbody>
                    <?php
			   $SQL=mysqli_query($conn, "SELECT * FROM tboking_temp WHERE idSession='$_SESSION[username]'");
			   $no=1;
			   if($no % 2==1){
					   $class="gradeU";
				...
				while($_data=mysql_fetch_array($conn, $SQL)){
                  ...
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="85%"><h4>Invoice Boking Lapangan Vigor </h4>
                        <a href="#" class="tip-bottom" title="Kasir">Kasir</a> |  <a href="#" class="tip-bottom" title="BCA (78889991) - Mandiri (788928292)-BRI (082928938) ">BCA (78889991) - Mandiri (788928292)-BRI (082928938) </a> |  <a href="#" class="tip-bottom" title="SWIFT code">Design By :  </a>|  <a href="#" class="tip-bottom" title="IBAN Billing address">PENYOK </a></td>
                      <td class="right"><strong>Total Bayar</strong> <br>
                        </td>
                        <?php
						$to=mysqli_query($conn, "SELECT SUM(subTotalTemp) AS subtotal FROM tboking_temp WHERE idSession='$_SESSION[username]'");
