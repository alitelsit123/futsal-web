<?php
$SQL=mysqli_query($conn, "SELECT * FROM tjadwal WHERE kdJadwal='$_GET[id]'");
          ...
          <div class='control-group'>
              ...
              <div class='controls'>
				...
				if($_data['kdLapangan']==0){
				 ...
				 $lapangan=mysqli_query($conn, "SELECT * FROM tlapangan ORDER BY noLapangan ASC");
              ...
              <div class='controls'>
				...
				if($_data['kdJam']==0){
				 ...
				 $jam=mysqli_query($conn, 'SELECT * FROM tjam ORDER BY jam ASC');
