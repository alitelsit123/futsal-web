  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <?php
		$totInvoice=mysqli_query("SELECT * FROM tboking");
        ...
        <?php
		$totInvoiceLunas=mysqli_query("SELECT * FROM tboking WHERE statusBayar='L'");
        ...
        <?php
		$totInvoiceB=mysqli_query("SELECT * FROM tboking WHERE statusBayar='B'");
        ...
        <?php
		$totMember=mysqli_query("SELECT * FROM tmember");
        ...
        <?php
		$tgl=date("Ymd");
		$totJadwal=mysqli_query("SELECT * FROM tjadwal WHERE tglJadwal='$tgl' ");
        ...
        <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
               <?php
			   $SQL=mysqli_query("SELECT * FROM tboking  ORDER BY noInvoice ASC");
			   $no=1;
