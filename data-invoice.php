                    ...
                    <div class="panel panel-default">
                        ...
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                             <thead>
									...
									$SQL="SELECT * FROM trincian_boking INNER JOIN tboking ON trincian_boking.kdBoking=tboking.kdBoking WHERE tboking.usernameBoking='$_SESSION[username]'";
									$ExecuteQuery=mysqli_query($conn, $SQL)or die(mysqli_error());
