				 ...
				 <h4 class="page-section-heading"> DAFTAR RINCIAN KERANJANG BOKING</h4>
                    <div class="panel panel-default">
                       ...
                       <table class="table">
                                  ...
                                  <?php
								  $query=mysqli_query($conn, "SELECT MAX(noInvoice) As noInvoice FROM tboking");
							...
							echo"<label class='label label-danger'><h5><font color='#FFFFFF'>INVOICE : <strong># $newID </font></strong></h5></label>";
								  ?>
                                    ...
                                    <?php
						$boking=mysqli_query($conn, "SELECT * FROM tboking_temp WHERE idSession='$_SESSION[username]'");
						$no=1;
						while($_data=mysqli_fetch_array($boking)){
							...
							";
                                    ...
                                    <tr>
                                      ...
                                      <?php
									  $Total = mysqli_query($conn, "SELECT SUM(subTotalTemp) AS subtotal FROM tboking_temp WHERE idSession='$_SESSION[username]'");
